	   ...
	   <div class="ui segment">
			<form class="ui form">
	  			<div class="three fields">
	    			...
	    			<div class="seven wide field">
	    				<label>Slug</label>
	    		 		<input type="text" name="slug" id="slug" disabled placeholder="Untuk URL">
	    			</div>
	    			<div class="two wide field">
	    				<input type="file" (change)="fileEvent($event)" name="foto" id="labelinput" style="opacity: 0;overflow: hidden;margin-top: -28px;" />
